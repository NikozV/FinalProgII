...
def menu_pantalla():
    ...
    try:
        pantalla.iconbitmap("img/loginuser.ico") #Icono .ico
    except:
        pass
    ...
    #IMAGEN
    image=PhotoImage(file="img/icon-login.gif") #Llamo una imagen
...
def menu_inicio_sesion():
    ...
    try: 
        pantalla1.iconbitmap("img/loginuser.ico") #Icono .ico
    except:
        pass
...
def menu_registrar():
    ...
    pantalla2.iconbitmap("img/loginuser.ico") #Icono .ico
